...
<form method="get" action="search.php">
	...
	<input type="text" name="titleSearch" placeholder="titre" value="<?= $_GET['titleSearch'] ?>"></input>
	<input type="text" name="actorSearch" placeholder="Nom de l'acteur" value="<?= $_GET['actorSearch'] ?>"></input>
